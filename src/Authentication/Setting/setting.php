...
<head>
  ...
  <!-- para centralized, reusable yung code -->
...
<div class="sidebar">
    ...
    <a class="menu-item active" href="../Setting/setting.php"><i class="bi bi-gear-fill"></i> Settings</a>
...
<!-- js, hindi ko muna ihiniwalay. nalilito ako magpalipat-lipat -->
<script>
