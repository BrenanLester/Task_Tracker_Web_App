    ...
    <div class="modal-content">
        ...
        <form onsubmit="saveTask(event)">
            ...
            <div class="modal-actions d-flex justify-content-end gap-2 mt-4">
                <button type="button" onclick="closeModal()" class="btn btn-secondary cancel-btn">Cancel</button>
                <button type="submit" class="btn btn-primary save-btn" id="submit-btn">Add Task</button>
            </div>
        </form>
    </div>
</div>
